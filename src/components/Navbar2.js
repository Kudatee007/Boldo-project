...
import boldoLogo2 from "../images/Logo2.svg";
      ...
      <nav className="py-10 md:flex md:items-center md:justify-between relative">
        <div className="flex justify-between items-center">
          <Link to="/">
            {" "}
            <div>
              <img src={boldoLogo2} alt="" className="h-10" />
            </div>
          </Link>
        ...
        >
          <li className="mx-4 my-6 md:my-0">
            {" "}
            <h1 className="text-slate-950 text-xl hover:text-slate-500 duration-500">
              Product
            </h1>
          </li>
          <li className="mx-4 my-6 md:my-0">
          ...
          <button className="border border-black w-32 h-11 rounded-3xl Open Sans font-semibold text-base md:mx-4 hover:text-slate-500 hover:bg-slate-400 duration-500">
            Log In
          </button>
        </ul>
      </nav>
